...
| [AIED-03](AIED-03-preset-prompts.md) | Preset prompts (Format / Simplify / Table) | Must | M1 | AIED-01 | S |
...
- **M3 — Personalization:** `AIED-08`, `AIED-09`. Persist conversations, then suggest prompts from them.
